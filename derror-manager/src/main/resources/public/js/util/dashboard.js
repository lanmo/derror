...
//                 regCenterDisplayName = "<b>" + regCenterName + "(<span data-lang='status-opened'></span>)</b>";
//             } else {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data) {
                    ...
                    /*refreshJobNavTag();
                    refreshServerNavTag();*/
                    $("#content").load("/global/appconfig_center.html");
