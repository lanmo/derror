...
package org.jfaster.derror.log4j.plugin.event;
 ...
 * @author yangnan
 */
public class Log4jEvent extends AbstractLoggingEvent {

    @Setter
    @Getter
    private InternalLogLevel level;

    public Log4jEvent(Level logLevel) {
    ...
    public Log4jEvent(Level level, ThrowableInformation throwableProxy) {
        this(level);
